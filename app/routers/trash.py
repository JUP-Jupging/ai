...
# 0-based 세부 라벨(15종)
FINE_LABELS_0BASED = {
    0:"종이", 1:"종이팩", 2:"종이컵", 3:"캔류", 4:"재사용 유리",
    5:"갈색 유리", 6:"녹색 유리", 7:"백색 유리", 8:"기타 유리",
    9:"페트", 10:"플라스틱", 11:"비닐",
    12:"흰색 스티로폼", 13:"컬러 스티로폼", 14:"건전지",
}
...
GROUP_MAP_0BASED = {
    **{i:"종이" for i in [0,1,2]},
    3:"캔",
    **{i:"유리" for i in [4,5,6,7,8]},
    **{i:"플라스틱" for i in [9,10]},
    11:"비닐",
    **{i:"스티로폼" for i in [12,13]},
    14:"건전지",
}
